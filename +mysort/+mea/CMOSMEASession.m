classdef CMOSMEASession < mysort.ds.PreFilteredDataSourceInterface & ...
    ...
    methods
        %------------------------------------------------------------------
        function self = CMOSMEASession(fname, h5info, prefilterfname, prefh5info, preprocessfname, preproch5info, filterFactory, session_idx, useFilter)
            ...
            self.message = 'unkown';
            if mysort.h5.exist(self.fname, [self.session_str 'message'], h5info)
